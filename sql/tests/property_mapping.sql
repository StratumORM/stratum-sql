...
delete orm_meta_types
where name in ('triangle','square','pentagon','homeBase')
go

insert into orm_meta_types (name)
values	('triangle')
	,	('square')
	,	('pentagon')
	,	('homeBase')
...
-- Get homeBase to inherit new properties from new types.
...
/*
insert into orm_meta_types (name) values ('asdf')

update orm_meta_types
set name = 'qazwsx'
where name = 'asdf'
