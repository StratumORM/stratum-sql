...
IF OBJECT_ID('[orm].[orm_meta_decodeUpdatedColumnsBitmask]', 'FN') IS NOT NULL
	drop function [orm].orm_meta_decodeUpdatedColumnsBitmask
go

create function [orm].orm_meta_decodeUpdatedColumnsBitmask
(
