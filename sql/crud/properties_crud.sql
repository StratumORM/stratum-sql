...
IF OBJECT_ID('[dbo].[orm_property_add]', 'P') IS NOT NULL
	DROP PROCEDURE [dbo].orm_property_add
go
...
IF OBJECT_ID('[dbo].[orm_property_remove]', 'P') IS NOT NULL
	DROP PROCEDURE [dbo].orm_property_remove
go
...
IF OBJECT_ID('[dbo].[orm_property_rename]', 'P') IS NOT NULL
	DROP PROCEDURE [dbo].orm_property_rename
go
